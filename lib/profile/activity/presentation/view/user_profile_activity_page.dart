...
import 'package:moony_app/profile/common/presentation/view/user_profile_banner_widget.dart';
...
class UserProfileActivityPage extends GetView<UserProfileActivityController> {
  ...
  List<Widget> getItems(List<UserProfileActivityItemUi> list) {
    ...
    for (final UserProfileActivityItemUi element in list) {
      activities.add(
        UserProfileActivityItemWidget(
            item: element, showDelay: element.delay > 5,),
      );
    }
    return activities;
  }
