  ...
  Future<UserProfileDetailPreferenceDataModel> getProfilePreferences(
    ...
    switch (categoryId) {
      ...
      case userProfileCategoryGender:
        {
          res.add(UserProfileRawPreferenceDataModel(title: "Femme", id: "400"));
          res.add(UserProfileRawPreferenceDataModel(title: "Homme", id: "401"));
          res.add(UserProfileRawPreferenceDataModel(title: "Autre", id: "402"));
        }
        break;
      default:
        {
...
/**sealed class UserProfilePreference() {
