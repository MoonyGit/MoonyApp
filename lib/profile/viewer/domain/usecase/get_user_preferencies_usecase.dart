...
class GetUserPreferencesUseCase extends AsyncParamUseCase<UserProfileCategoryId,
    UserProfileAggregatePreferenceEntity> {
  /// Constructor
  GetUserPreferencesUseCase(
    this._userProfileRawPreferenceRepository,
  ...
  Future<UserProfileAggregatePreferenceEntity> call({
    ...
    /// Get raw preference for a given category
    ...
    final List<UserProfileSelectedPreferenceEntity> selectedProfilePreferences =
        await _userProfileSelectedPreferenceRepository.getPreferences(
      id: input,
    );
    ...
    return UserProfileAggregatePreferenceEntity(
      ...
      moonyMessage: UserProfileMoonyMessage(
        input: rawProfilePreferences.moonyMessage.getOrCrash(),
      ),
    );
  }
}
