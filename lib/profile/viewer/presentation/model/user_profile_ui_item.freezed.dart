...
class _$UserProfileUiTearOff {
  ...
  UserProfileItem item(
      {required String title, required String icon, required String id}) {
...
mixin _$UserProfileUi {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String title, String icon, String id) item,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(String title, String icon, String id)? item,
...
abstract class $UserProfileItemCopyWith<$Res> {
  ...
  $Res call({String title, String icon, String id});
}
...
class _$UserProfileItem implements UserProfileItem {
  const _$UserProfileItem(
      {required this.title, required this.icon, required this.id});
  ...
  @override
  String toString() {
    return 'UserProfileUi.item(title: $title, icon: $icon, id: $id)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return item?.call(title, icon, id);
  }
...
abstract class UserProfileItem implements UserProfileUi {
  const factory UserProfileItem(
      {required String title,
      required String icon,
      required String id}) = _$UserProfileItem;
