...
class SwipeCardWidget extends StatelessWidget {
        ...
        children: <Widget>[
          Container(
            ...
            child: Image.network(model.imageUrl,
                height: cardHeight, fit: BoxFit.cover),
          ),
          Column(
            children: <Widget>[
              Expanded(
                          ...
                          child: model.when<Widget>(
                            mainInfo: (String imageUrl,
                                ...
                                _createActivityInfoWidget(
                                    ...
                                    activityLocation,
                                    activityTargetDate),
                            userHobby: (String imageUrl,
                                    String userName,
                                    int userAge,
                                    bool userVerified,
                                    List<String> userHobbyList) =>
                                _createUserHobbyWidget(userName, userAge,
                                    userVerified, userHobbyList),
                            userInfo: (String imageUrl,
                                    String userName,
                                    int userAge,
                                    bool userVerified,
                                    String location,
                                    int distance) =>
                                _createUserInfoWidget(userName, userAge,
                                    userVerified, location, distance),
                            activityDesc: (String imageUrl,
                                    String activityName,
                                    String activityCategoryImageUri,
      ...
      Column(
        ...
        children: <Widget>[
          _createActivityHeader(
              activityName: activityName, moreInfoLink: activityMoreInfoLink),
  ...
  Widget _createUserHobbyWidget(String userName, int userAge, bool userVerified,
      ...
      Column(
          ...
          children: <Widget>[
            ...
            Wrap(spacing: 5, runSpacing: 10, children: <Widget>[
              ...hobbyList
                  .map((String hobby) => _createOpacityChipWith(
                      label: hobby,
                      backgroundColor: Colors.white70.withOpacity(0.8)))
                  .toList()
            ])
  ...
  Widget _createUserInfoWidget(String userName, int userAge, bool userVerified,
          String location, int distance) =>
      Column(
          mainAxisAlignment: MainAxisAlignment.end,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
      ...
      Row(
        ...
        Text(
          ...
          style: const TextStyle(
            ...
            shadows: <Shadow>[
              Shadow(
                  offset: Offset(2, 2), blurRadius: 1.5, color: Colors.black38)
            ],
          ),
        ),
      ].also((List<Widget> row) {
  ...
  Widget _createOpacityChipWith(
      ...
      Theme(
          data:
              Theme.of(Get.context!).copyWith(canvasColor: Colors.transparent),
          child: Chip(
            label: Padding(
