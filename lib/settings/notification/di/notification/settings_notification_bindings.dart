...
import 'package:moony_app/settings/notification/data/setting_notification_repository_impl.dart';
...
class SettingNotificationBindings extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut(
      () => SetSettingLikeUseCase(Get.find<SettingRepositoryImpl>()),
    );
    Get.lazyPut(
      () => GetSettingLikeUseCase(Get.find<SettingRepositoryImpl>()),
    );
    ...
    Get.lazyPut(
      () => GetEventUseCase(Get.find<SettingRepositoryImpl>()),
    );

    Get.lazyPut(
      () => SetEventUseCase(Get.find<SettingRepositoryImpl>()),
    );

    Get.lazyPut(
      () => GetPromotionUseCase(Get.find<SettingRepositoryImpl>()),
    );

    Get.lazyPut(
      () => SetPromotionUseCase(Get.find<SettingRepositoryImpl>()),
    );

    Get.lazyPut(
      () => GetNewsUseCase(Get.find<SettingRepositoryImpl>()),
    );

    Get.lazyPut(
      () => SetNewsUseCase(Get.find<SettingRepositoryImpl>()),
    );

    Get.lazyPut(
      () => GetSurveyUseCase(Get.find<SettingRepositoryImpl>()),
    );

    Get.lazyPut(
      () => SetSurveyUseCase(Get.find<SettingRepositoryImpl>()),
    );
