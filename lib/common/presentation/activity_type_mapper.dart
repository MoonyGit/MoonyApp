...
/// Mapper ext to retrieve presentation info on activity type
extension ActivityTypeMapperSet on Set<ActivityType> {
  /// Get title
  Set<String> getTitle() => map((ActivityType e) => e.getTitle()).toSet();
}
...
/// Mapper ext to retrieve presentation info on activity type
extension ActivityCategoryMapperSet on Set<ActivityCategory> {
  /// Get title
  Set<String> getTitle() => map((ActivityCategory e) => e.getTitle()).toSet();

  /// Get icon
  Set<IconData> getIcon() => map((ActivityCategory e) => e.getIcon()).toSet();
}
