...
@override
Future<bool> setSwipeDecision({required String userId,
...
SwipeItemDataModel _generateSwipeItemMock() =>
    SwipeItemDataModel(
...
SwipeCreatorInfoDataModel _generateCreatorInfo() =>
...
//#region Activity creation impl
  @override
  Future<HttpFailure?> createActivity({required ActivityCreationDataModel
  activity}) async {
    return null;
  }
//#endregion
